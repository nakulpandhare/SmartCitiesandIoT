...
while True:
    ...
    if distance1 > 0 and distance1 < 30 and i == 1 and state1:
        # Object detected by sensor 1 and expecting it
        state1 = False
        time.sleep(0.1)
        i += 1

    elif distance2 > 0 and distance2 < 30 and i == 2 and state2:
    ...
    elif distance2 > 0 and distance2 < 30 and i == 1 and state2:
        # Object detected by sensor 2 first, indicating exiting sequence
        state2 = False
        time.sleep(0.1)
        i = 2

    elif distance1 > 0 and distance1 < 30 and i == 2 and state1:
